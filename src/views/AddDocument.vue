              ...
              <tbody>
                ...
                <tr class="border border-white">
                  ...
                  <td class="p-3 border border-white w-1/2">
                    ...
                    <input type="email" v-model="userData.email" class="form-input w-full" disabled />
                  </td>
                </tr>
                ...
                <tr class="border border-white">
                  <td class="p-3 border border-white">
                    ...
                    <select v-model="type" class="form-input w-full" required>
                  ...
                  <td class="p-3 border border-white">
                    ...
                    <input type="text" v-model="userData.advisor" class="form-input w-full" disabled />
                  </td>
                </tr>
                ...
                <tr class="border border-white">
                  <td class="p-3 border border-white">
                    ...
                    <select v-model="leaveType" class="form-input w-full" required>
